...
import co.sharechat.flows.AndroidFlow;
import co.sharechat.flows.iOSFlow;
...
public class ViewFactory extends DeviceHelper {
    ...
    public co.sharechat.config.DeviceInterface getMobilePlatform(String platform, AppiumDriver<MobileElement> driver) {
        if (platform == null) {
